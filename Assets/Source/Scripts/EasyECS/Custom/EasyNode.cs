...
namespace Source.EasyECS
{
    public class EasyNode : BootstrapComponent
    {
        ...
        public static Componenter EcsComponenter
        {
            get => Instance._componenter;
            private set => Instance._componenter = value;
        }

        public static GameConfiguration GameConfiguration
        {
            get => Instance._gameConfiguration;
            private set => Instance._gameConfiguration = value;
        }
        ...
        public override void Initialize()
        {
            ...
            GameConfiguration = GameShare.GetSharedObject<GameConfiguration>();
        }
    }
}