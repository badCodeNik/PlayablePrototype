...
namespace Source.Scripts.Ecs.Systems
{
    public class EnemyAttackSystem : EasySystem
    {
        ...
        {
            _playerFilter = World.Filter<PlayerMark>().Exc<DestroyingData>().End();
        ...
        private void TryAttack()
        {
            ...
            foreach (var enemyEntity in _readyAttackFilter)
            {
                ...
                var playerTransform = Componenter.AddOrGet<TransformData>(playerEntity).Value;
                ...
                else
                {
                    ...
                    var newObject = Object.Instantiate(attackingData.ProjectilePrefab, enemyTransform.position,
